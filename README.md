...
**[Hello-react-front-end]** is a practice project in which I configured react and rails as two apps. This project serves as a front end for [Hello-react-front-end](https://github.com/Zuhaib042/hello-rails-back-end.git).
...
- Here is the Backend part of the project [Hello Rails Backend](https://github.com/Zuhaib042/hello-rails-back-end.git)
...
```
git clone https://github.com/Zuhaib042/hello-react-front-end.git
```
